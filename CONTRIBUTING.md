...
**1.** Fork [this](https://github.com/twimbit/twimintel/) repository.

**2.** Clone the forked repository.
```terminal
git clone https://github.com/<your-github-username>/twimintel.git
```
...
**9.** **Congratulations!** Sit and relax, you've made your contribution to the [twimintel](https://github.com/twimbit/twimintel/) project.
